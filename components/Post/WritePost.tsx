...
export default function WritePost() {
  ...
  const onPostButtonClick = async () => {
    ...
    try {
      ...
      ToastAndroid.show("Failed to post. Please try again.", ToastAndroid.BOTTOM);
    } finally {
      setLoading(false);
    }
  };
    ...
    <View>
      ...
      <View style={{ marginTop: 15 }}>
        <DropDownPicker
          ...
          setValue={setValue}
          setItems={setItem}
          style={{ borderWidth: 0, elevation: 1 }}
        />
      </View>
      <Button text="Post" onPress={onPostButtonClick} loading={loading} />
    </View>
  );
}
